import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c,a as n,e as a,r as p}from"./app.5467808e.js";const u={},l=a('<h2 id="concept" tabindex="-1"><a class="header-anchor" href="#concept" aria-hidden="true">#</a> Concept</h2><p>Since module instances are loosely coupled, the message module allows modules to communicate together internally.</p><div class="custom-container tip"><p class="custom-container-title">Event Bubbling</p><p>when initializing modules with reference to instance of modules, the event module will by default subscribe to reference event provider.</p><p>For example when the Provider (Portal) initializes a consumer (App), the app will dispatch events that <code>canBubble</code> to its parent event module instance.</p></div><div class="custom-container warning"><p class="custom-container-title">Async listeners</p><p>event handlers are allowed to execute async, so when <code>event.cancelable = false</code> the dispatcher will not await resolution, which means the cancellation might not happen in the order which handlers where added</p></div><h3 id="dispatch-event" tabindex="-1"><a class="header-anchor" href="#dispatch-event" aria-hidden="true">#</a> Dispatch event</h3>',5),i=a(`<div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code>modules<span class="token punctuation">.</span>event<span class="token punctuation">.</span><span class="token function">dispatchEvent</span><span class="token punctuation">(</span>
