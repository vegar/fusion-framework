...
export type ActionInstanceMap<T extends Record<string, any>> = T extends Record<
    string,
    ActionCreator
>
    ? {
...
export type ActionPayload<T> = ActionInstance<T> extends PayloadAction<any>
    ? ActionInstance<T>['payload']
    : never;

export type ActionMeta<T> = T extends PayloadAction<void, string, infer U> ? U : never;

export type ActionError<T> = T extends PayloadAction<void, string, any, infer U> ? U : never;
